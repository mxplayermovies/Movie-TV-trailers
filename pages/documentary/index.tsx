...
// export default function DocumentaryPage({ items }: Props) {
//   const [visibleCount, setVisibleCount] = useState(ITEMS_PER_PAGE);
//   const totalItems = items.length;
//   const hasMore = visibleCount < totalItems;

//   useEffect(() => {
//     voiceManager.speak('Documentary page. Browse the latest documentary movies. Click the speaker icon to learn about the latest updated documentary Movies.');
//   }, []);
...
//   const items = UNIQUE_DOCUMENTARY.map(sanitizeMediaItem);
//   return {
//     props: { items },
//     revalidate: 3600,
//   };
        ...
        <main className="container mx-auto px-4 py-8">
          <div className="flex justify-between items-center mb-8">
            ...
            <p className="page-text hidden">
              We have {items.length} latest documentary available. Updated as on {buildDateString}.
            </p>
            <span className="p-2 dark:text-gray-300 mb-4">Read details aloud</span>
            <button
              onClick={readPageContent}
