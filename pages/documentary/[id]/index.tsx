// // pages/documentary/[id]/index.tsx
// import React, { useEffect, useState, useCallback, useRef } from 'react';
// import Head from 'next/head';
// import { GetStaticPaths, GetStaticProps } from 'next';
// import { useRouter } from 'next/router';
// import { UNIQUE_DOCUMENTARY, getImageUrl } from '../../../services/tmdb';
...
//   const title = item.title || item.name || 'Documentary';
//   const ytId = item.yt_id;
//   const canonicalUrl = `${BASE_URL}/documentary/${item.id}`;
...
//             </div>
//           </div>
//           <div className="mt-12"><Recommendations items={recommendations} basePath="/documentary" title="More Documentary" /></div>
//         </main>
//         <Footer />
//       </div>
//     </>
...
//   paths: UNIQUE_DOCUMENTARY.map((item) => ({ params: { id: String(item.id) } })),
//   fallback: 'blocking',
// });
...
//   try {
//     const movie = UNIQUE_DOCUMENTARY.find((m) => String(m.id) === id);
...
//     const recommendations = UNIQUE_DOCUMENTARY.filter((m) => String(m.id) !== id).slice(0, 6).map((m) => sanitizeMediaItem(m));
//     return { props: { item: sanitizedItem, recommendations, ogImage }, revalidate: 3600 };
//   } catch (error) {
//     console.error(`Error in getStaticProps for documentary ${id}:`, error);
...
//   // Set background music for this item (or null if none)
//   useEffect(() => {
