...
//               {/* Sports details and watch button */}
//               <div className="mt-4">
...
export default function SportsDetail({ item, recommendations, ogImage }: Props) {
  ...
  useEffect(() => {
    if (title) {
      voiceManager.speak(`Now viewing ${title}. Click the speaker icon to learn more.`);
    }
  }, [title]);
    ...
    <>
      ...
      <div className="min-h-screen bg-slate-50 dark:bg-[#0f172a]">
        ...
        <main className="container mx-auto px-4 py-8">
          ...
          <div className="mt-12">
            <Recommendations items={recommendations} basePath="/sports" title="More Live Sports" />
          </div>
        </main>
        <Footer />
      </div>
