...
// export default function SportsPage({ items }: Props) {
//   const [visibleCount, setVisibleCount] = useState(ITEMS_PER_PAGE);
//   const totalItems = items.length;
//   const hasMore = visibleCount < totalItems;

//   useEffect(() => {
//     voiceManager.speak('Live Sports page. Browse the latest Live Sporting action. Click the speaker icon to learn about the latest updated Sporting action.');
//   }, []);
...
//       year: 'numeric'
//     });
//     const text = ` We have ${items.length} Live Sports Sessions available. Updated as on ${formattedDate}. `;
...
//   const items = UNIQUE_SPORTS.map(sanitizeMediaItem);
//   return {
//     props: { items },
//     revalidate: 3600,
//   };
        ...
        <main className="container mx-auto px-4 py-8">
          <div className="flex justify-between items-center mb-8">
            ...
            <p className="page-text hidden">
              We have {items.length} Live Sports Sessions available. Updated as on {buildDateString}.
            </p>
            <span className="p-2 dark:text-gray-300 mb-4">Read details aloud</span>
            <button
              onClick={readPageContent}
