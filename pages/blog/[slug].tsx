...
//   const getFullPostText = useCallback((): string => {
//     if (!post) return '';
//     const plainContent = stripHtml(post.content);
//     return `${post.title}. ${plainContent}`;
//   }, [post, stripHtml]);

//   // Auto‑speak the full post content after a short delay (once on mount)
//   useEffect(() => {
//     if (!post) return;
...
//   }, [post, getFullPostText]);

//   const readFullPost = useCallback(() => {
//     const fullText = getFullPostText();
//     if (fullText) {
//       voiceManager.speak(fullText, true); // true = interrupt any ongoing speech
//     }
//   }, [getFullPostText]);
...
//   /**
//    * Extract the current translated text directly from the DOM.
//    * Google Translate modifies the text content of these elements,
//    * so this always returns the language the user sees.
//    */
//   const getTranslatedPostText = useCallback((): string => {
//     if (typeof document === 'undefined') return '';
//     const titleEl = document.querySelector('h1');
//     const contentEl = document.querySelector('.prose'); // the blog body
//     let text = '';
...
//   // Auto‑speak after a delay that allows Google Translate to finish
//   useEffect(() => {
//     if (!post) return;
//     const timer = setTimeout(() => {
//       const translatedText = getTranslatedPostText();
//       if (translatedText) {
//         // VoiceManager will use the browser's built‑in language detection
//         // (or you can pass a specific language if needed)
...
//     return () => clearTimeout(timer);
//   }, [post, getTranslatedPostText]);

//   // Manual read – uses the current translated DOM content
//   const readFullPost = useCallback(() => {
//     const translatedText = getTranslatedPostText();
//     if (translatedText) {
//       voiceManager.speak(translatedText, true); // true = interrupt previous speech
//     }
//   }, [getTranslatedPostText]);
...
//   // Structured data for SEO (original English data – this does not affect the spoken text)
//   const blogPostingSchema = {
//     "@context": "https://schema.org",
//     "@type": "BlogPosting",
//     "headline": post.title,
...
//             {/* This div contains the blog content – Google Translate will modify it */}
//             <div
//               className="prose prose-lg dark:prose-invert max-w-none"
//               dangerouslySetInnerHTML={{ __html: post.content }}
//             />
