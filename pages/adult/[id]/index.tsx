...
// import { UNIQUE_ADULT, getDetails } from '../../../services/tmdb';
...
// export default function AdultDetail({ item, recommendations }: Props) {
...
//         <meta property="og:url" content={`https://movie-tv-trailers.vercel.app/adult/${item.id}`} />
...
//           <Recommendations items={recommendations} basePath="/adult" title="More Adult Movies" />
//         </main>
//         <Footer />
//       </div>
//     </>
...
//   const title = item.title || item.name || 'Movie';
//   const ytId = item.yt_id;
//   const shareUrl = `${BASE_URL}/adult/${item.id}`;
