  ...
  return (
    <div className="min-h-screen bg-miraj-black pt-24 pb-20 relative">
      ...
      <div className="container mx-auto px-4 md:px-6 max-w-4xl">
        ...
        <div className="bg-miraj-gray border border-white/5 rounded-2xl p-6 md:p-10 mb-8">
          <h2 className="text-2xl font-bold text-white mb-4">Our Android App</h2>
          <p className="text-gray-300 leading-relaxed">Enjoy a native mobile experience with our Android app, available directly from our website. Get push notifications for new content and a smoother streaming experience on the go.</p>
        </div>
