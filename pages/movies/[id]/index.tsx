            ...
            <div className="min-w-0">
              ...
              <div className="mt-8 pt-6 border-t border-slate-200 dark:border-white/10">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(canonicalUrl)}&text=${encodeURIComponent(`${title} – Watch Online HD`)}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  <button
                    onClick={handleCopy}
                    className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-semibold transition ${copied ? 'bg-green-600 text-white' : 'bg-slate-200 dark:bg-white/10 text-gray-800 dark:text-white hover:bg-slate-300 dark:hover:bg-white/20'}`}
                  >
