...
export default function SportsDetail({ item, recommendations }: Props) {
  ...
  useEffect(() => {
    if (title) {
      voiceManager.speak(`Now viewing ${title}. Click the speaker icon to learn about the Movie details.`);
    }
  }, [title]);
    ...
    <>
      ...
      <div className="min-h-screen bg-slate-50 dark:bg-[#0f172a]">
        ...
        <main className="container mx-auto px-4 py-8">
          ...
          <Recommendations items={recommendations} basePath="/movies" title="More Movies You May Like !!! " />
        </main>
        <Footer />
      </div>
    </>
