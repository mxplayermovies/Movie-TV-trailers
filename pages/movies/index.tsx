...
//   // Set default background music for this category
//   useEffect(() => {
//     musicController.setCurrentMusicId(DEFAULT_BG_MUSIC_IDS.movies);
...
//           <div className="flex justify-between items-center mb-8">
//             <h1 className="text-3xl md:text-4xl font-bold">Movies</h1>
//             <p className="page-text hidden">We have {items.length} movies available. Updated as on {buildDateString}. We update our content regularly to ensure you have the latest and greatest movie trailers and information.every 24 hours. Watch our Latest movie library and enjoy the best free streaming experience.</p>
//             <div className="flex items-center gap-2">
//               <span className="text-sm text-gray-500 dark:text-gray-300">Read details aloud</span>
//               <button onClick={readPageContent} className="p-2 bg-blue-500/20 text-blue-400 rounded-full hover:bg-blue-500 hover:text-white transition" title="Read page aloud" aria-label="Read page aloud">
//                 <Volume2 size={20} />
...
export default function MoviesPage({ items, buildDateString }: Props) {
  ...
  // Load voiceManager, start continuous music, and schedule auto‑speak
  useEffect(() => {
    let cancelled = false;
    import('../../lib/core/VoiceManager').then(({ voiceManager }) => {
      if (cancelled) return;
      ...
      voiceManager.playBackgroundMusic(DEFAULT_BG_MUSIC_IDS.movies);
