...
//     const itemsCount = document.querySelector('.grid')?.previousElementSibling as HTMLElement;
//     // const textElement = document.querySelector(".page-text") as HTMLElement;
//     let text = '';
...
//   We have {items.length} movies available. Updated as on{" "}
...
//           <div className="flex justify-between items-center mb-8">
//             <h1 className="text-3xl md:text-4xl font-bold">Movies</h1>
//             {/* Hidden paragraph – exactly as before, but using server‑generated date */}
//             <p className="page-text hidden">
//               We have {items.length} movies available. Updated as on {buildDateString}.
//             </p>
//             <span className="p-2 dark:text-gray-300 mb-4">Read details aloud</span>
//             <button
//               onClick={readPageContent}
...
//   // This ensures the server and client render exactly the same string.
