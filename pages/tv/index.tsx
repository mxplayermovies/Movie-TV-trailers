...
// export default function TvShowsPage({ items }: Props) {
...
//       year: 'numeric',
//     });
//     const text = `We have ${items.length} TV shows available. Updated as on ${formattedDate}. `;
...
//   We have {items.length} TV Shows available. Updated as on{" "}
      ...
      <div className="min-h-screen bg-slate-50 dark:bg-[#0f172a]">
        ...
        <main className="container mx-auto px-4 py-8">
          <div className="flex justify-between items-center mb-8">
            ...
            <p className="page-text hidden">
              We have {items.length} TV Shows available. Updated as on {buildDateString}.
            </p>
            <span className="p-2 dark:text-gray-300 mb-4">Read details aloud</span>
            <button
              onClick={readPageContent}
