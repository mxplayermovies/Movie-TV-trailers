...
// import Hero from '../components/Hero';
// import Footer from '../components/Footer';
// // ✅ NO top-level voiceManager import
// import {
//   Volume2, Send, Film, Tv, Trophy, Radio, Users, Globe, Download,
// } from 'lucide-react';
...
// const SITE_NAME = 'Movie & TV Trailers';
// const SITE_TITLE = 'Movie & TV Trailers – Free Movies, TV & Live Sports';
// const SITE_DESC = 'Watch free movies, TV shows, live sports, and more online. No sign‑up required.';

// export default function Home() {
//   const voiceRef = useRef<{ speak: (t: string, f?: boolean) => void } | null>(null);
...
//         'Movie & TV trailers. We offer Movies, TV Shows, Live Sports, Live TV, Hindi Dubbed Movies, and Adult Content. Browse our categories and start watching instantly.',
//         true
//       );
//     } catch { /* ignore */ }
//   };
...
//         <title>{SITE_TITLE}</title>
//         <meta name="description" content={SITE_DESC} />
//         <meta name="keywords" content="free movies, new trailers bollywood, hindi movie trailer new, new bollywood movies trailer, best movie trailers, hindi dubbed" />
//         <link rel="canonical" href={BASE_URL} />
//         <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=5" />
...
//                 className="absolute top-0 right-4 md:right-0 p-2 bg-blue-500/20 text-blue-400 rounded-full hover:bg-blue-500 hover:text-white transition-all z-10"
//                 title="Read page overview"
//                 aria-label="Read page overview aloud"
//               >
//                 <Volume2 size={20} />
//               </button>
...
//               </p>
//               <a href="https://t.me/movieandtvshowondemand" target="_blank" rel="noopener noreferrer"
//                 className="inline-flex items-center gap-2 px-5 py-2 bg-[#26A5E4] hover:bg-[#1e8bc3] text-white font-semibold rounded-lg transition">
//                 <Send size={18} /> Request on Telegram
//               </a>
//             </div>
...
//               </p>
//               <a href="https://median.co/share/bnlpkdo" target="_blank" rel="noopener noreferrer"
//                 className="inline-flex items-center gap-2 px-5 py-2 bg-green-600 hover:bg-green-700 text-white font-semibold rounded-lg transition">
...
import { musicController } from '../lib/core/MusicController';          // ADDED
import { DEFAULT_BG_MUSIC_IDS } from '../lib/core/musicConfig';        // ADDED
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    import('../lib/core/VoiceManager').then(({ voiceManager }) => {
      ...
      // Start continuous background music for home page
      voiceManager.playBackgroundMusic(DEFAULT_BG_MUSIC_IDS.home);

      timer = setTimeout(() => {
        if (cancelled) return;
        try {
          voiceManager.speak(
            'Welcome to Movie & TV trailers. Your ultimate destination for Entertainment and more. We offer Movies, TV Shows, Live Sports, Live TV, Hindi Dubbed Movies, and Adult Content. Browse our categories and start watching instantly. Request a Movie or TV Show Cant find what your looking for? Join our Telegram channel and send your request directly. you can also Download the official Movie and TV trailers app for Android and enjoy seamless streaming on the go. Watch our Latest library and enjoy the best free streaming experience.',
            true,
            true // withMusic = true (will keep playing, but already started)
          );
        } catch { /* ignore */ }
      }, 2000);
    }).catch(() => {});
    return () => {
      cancelled = true;
      clearTimeout(timer);
      voiceRef.current?.stopBackgroundMusic(); // Stop music on unmount
    };
  }, []);
